...
(function( $ )
  ...
  Bubble = require('models/bubble').Bubble;

  BubbleView = require('views/bubble_view').BubbleView;

  exports.FieldView = (function(_super) {
    ...
    FieldView.prototype.initialize = function() {
      FieldView.__super__.initialize.apply(this, arguments);
...
(this.require.define({
  ...
  exports.Game = (function(_super) {
    ...
    function Game() {
      this.noMoreMoves = __bind(this.noMoreMoves, this);
    ...
    Game.prototype.initialize = function() {
      ...
      this.field.bind('scored', this.calculateScore);
      return this.field.bind('noMoreMoves', this.noMoreMoves);
    };
    ...
    Game.prototype.calculateScore = function(scoreToAdd) {
      ...
      return this.trigger('newTotalScore', this.get('score'), scoreToAdd);
    };

    Game.prototype.noMoreMoves = function(remainingBubbles) {
      return this.trigger('gameOver', this.get('score'), remainingBubbles);
    };
...
(this.require.define({
  ...
  AchievementManager = require('models/achievement_manager').AchievementManager;
  ...
  exports.User = (function(_super) {
    ...
    function User() {
      ...
      this.scored = __bind(this.scored, this);
    ...
    User.prototype.initialize = function() {
      ...
      return this.achievementManager = new AchievementManager(this);
    };

    User.prototype.setGame = function(game) {
      this.game = game;
      this.game.bind('newTotalScore', this.scored);
      return this.game.bind('gameOver', this.gameOver);
    };

    User.prototype.hasAchievement = function(achievementUrl) {
      var achievements;
      achievements = this.get('achievements');
      return achievements[achievementUrl] != null;
    };

    User.prototype.scored = function(newTotalScore, scored) {
      var gamesPlayed, highestClickScore;
      highestClickScore = this.get('highestClickScore');
      gamesPlayed = this.get('gamesPlayed');
      if (scored > highestClickScore) {
        this.set({
          'highestClickScore': scored
        });
        if (gamesPlayed > 0) $.publish('newHighestClickScore', [scored]);
        return this.save();
      }
    };

    User.prototype.gameOver = function(score, bubblesLeft) {
      var highestScore;
      this.set({
        'gamesPlayed': this.get('gamesPlayed') + 1,
        'accumulatedScore': this.get('accumulatedScore') + score
      });
      highestScore = this.get('highestScore');
    ...
    User.prototype.save = function(data, options) {
...
(this.require.define({
  ...
  exports.MainRouter = (function(_super) {
    ...
    MainRouter.prototype.initialize = function(user) {
      this.user = user;
    };
...
(this.require.define({
  ...
  exports.GameView = (function(_super) {
    ...
    GameView.prototype.initialize = function() {
      ...
      this.model.field.bind('currentScore', this.displayCurrentScore);
      this.model.bind('gameOver', this.gameOver);
      return this.model.bind('change:score', this.updateScoreView);
    };
    ...
    GameView.prototype.updateScoreView = function() {
      return $('#score').text("total  score: " + (this.model.get('score')));
    };

    GameView.prototype.gameOver = function(score, remainingBubbles) {};
...
(this.require.define({
  "helpers/notification_handler": function(exports, require, module) {
    (function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  exports.NotificationHandler = (function() {
    ...
    function NotificationHandler() {
      this.achievementUnlocked = __bind(this.achievementUnlocked, this);      this.el = $('#notifications');
      $.subscribe('achievementUnlocked', this.achievementUnlocked);
    }

    NotificationHandler.prototype.achievementUnlocked = function(achievement) {
      return this.showNotification(achievement.description);
    };

    NotificationHandler.prototype.showNotification = function(html) {
      var _this = this;
...
(this.require.define({
  "models/achievement": function(exports, require, module) {
    (function() {
  var __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  exports.Achievement = (function(_super) {

    __extends(Achievement, _super);

    function Achievement() {
      Achievement.__super__.constructor.apply(this, arguments);
    }

    Achievement.prototype.defaults = {
...
(this.require.define({
  "models/achievement_manager": function(exports, require, module) {
    (function() {
  var achievements,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  exports.AchievementManager = (function() {

    function AchievementManager(user) {
      this.user = user;
      this.gameOver = __bind(this.gameOver, this);
      $.subscribe('gameOver', this.gameOver);
    }

    AchievementManager.prototype.gameOver = function(score) {
      var achievement, as, user_achievements, _i, _len;
      user_achievements = this.user.get('achievements');
      as = achievements.select(function(achievement) {
        return achievement.get('check_on') === 'gameFinished';
      });
      for (_i = 0, _len = as.length; _i < _len; _i++) {
        achievement = as[_i];
        if (!_.contains(user_achievements, achievement.id) && achievement.get('constraint')(score) && !(this.user[achievement.get('blocker')] != null)) {
          user_achievements.push(achievement);
          this.user.set({
            'achievements': user_achievements
          });
          this.user[achievement.get('blocker')] = true;
...
(this.require.define({
  "models/field": function(exports, require, module) {
    (function() {
  var Bubble,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
  ...
  exports.Field = (function(_super) {
    ...
    Field.prototype.highlightBubbles = function(bubble) {
      ...
      this.trigger('currentScore', this.calculateScore(neighbors));
    ...
    Field.prototype.removeBubbles = function(bubble) {
      ...
      neighbors = this.getNeighborsOf(bubble);
      if (neighbors.length < 2) return;
      this.trigger('scored', this.calculateScore(neighbors));
    ...
    Field.prototype.checkForPossibleMoves = function() {
      ...
      if (!movesLeft) {
        ...
        return this.trigger('noMoreMoves', remaining);
      }
    };
...
(this.require.define({
  "initialize": function(exports, require, module) {
    (function() {
  var Application, BrunchApplication, BrunchBreaker, HomeView, MainRouter, NotificationHandler, User,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  NotificationHandler = require('helpers/notification_handler').NotificationHandler;
  ...
  Application = (function(_super) {
    ...
    Application.prototype.initialize = function() {
      var _ref;
      if (window.user_hash) {
        this.user = new User(window.user_hash);
        delete window.user_hash;
        $('#user_hash').remove();
      } else {
        this.user = new User();
      }
      this.router = new MainRouter(this.user);
      this.homeView = new HomeView;
      this.notificationHandler = new NotificationHandler();
      return this.isMobileDevice = ((_ref = navigator.userAgent.match(/(Android|webOS|iPhone|Ipod|iPad|BlackBerry|Windows Phone|ZuneWP7)/)) != null ? _ref.length : void 0) > 0;
    };
